...
var _ = BeforeSuite(func() {
	...
	require.NoError(f.T(), f.Deployment.EnsureContourConfigurationCRD())
	require.NoError(f.T(), f.Deployment.EnsureContourDeploymentCRD())
	...
	// TODO: Wait for Contour and Envoy available
})

var _ = AfterSuite(func() {
	// TODO: Delete contour resources
})
