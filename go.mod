...
replace (
	...
	github.com/envoyproxy/go-control-plane => github.com/sunjayBhatia/go-control-plane v0.9.10-0.20230609160027-d6eb72ac5ee4
	github.com/envoyproxy/go-control-plane/api => github.com/sunjayBhatia/go-control-plane/api v0.0.0-20230609160027-d6eb72ac5ee4
)
...
require (
	...
	github.com/envoyproxy/go-control-plane/api v0.11.1
