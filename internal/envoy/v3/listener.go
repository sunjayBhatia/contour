...
import (
	...
	accesslog "github.com/envoyproxy/go-control-plane/api/envoy/config/accesslog/v3"
	...
	envoy_gzip_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/compression/gzip/compressor/v3"
	envoy_compressor_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/compressor/v3"
	envoy_cors_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/cors/v3"
	envoy_config_filter_http_ext_authz_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/ext_authz/v3"
	envoy_config_filter_http_grpc_stats_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/grpc_stats/v3"
	envoy_grpc_web_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/grpc_web/v3"
	envoy_jwt_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/jwt_authn/v3"
	envoy_config_filter_http_local_ratelimit_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/local_ratelimit/v3"
	lua "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/lua/v3"
	envoy_rbac_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/rbac/v3"
	envoy_router_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/router/v3"
	envoy_proxy_protocol_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/listener/proxy_protocol/v3"
	envoy_tls_inspector_v3 "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/listener/tls_inspector/v3"
